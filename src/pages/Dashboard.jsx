...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchCredits = async () => {
      try {
        const response = await fetch('https://bitumen-backend-1.onrender.com/dashboard', {
          method: 'GET',
          credentials: 'include',
        });
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      const response = await fetch('https://bitumen-backend-1.onrender.com/dashboard/find', {
        method: 'POST',
        headers: {
